...
<input type="text" placeholder="Nome" name="professor" id="professor" value="<?= $professor_desc ?>" ><BR>

<input type="text" placeholder="Unidade" name="disciplina" id="disciplina" value="<?= $disciplina_desc ?>"><BR>
